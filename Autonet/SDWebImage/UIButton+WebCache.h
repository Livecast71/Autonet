 ...
 *
 * @param url The url for the image.
 * @param image The state that uses the specified title. The values are described in UIControlState.
 * @param image The image to be set initially, until the image request finishes.
