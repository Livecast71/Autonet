...
//
#import "AannameCategorieenView.h"
...
@implementation AannameCategorieenView
@synthesize AllLines;
...
{
    //appDelegate.Categorieen =[[FileManager getAannamelijstenCategorieen:@""] mutableCopy];
    ...
    UIButton *note =[[UIButton alloc]initWithFrame:CGRectMake(4,4, 60, 32)];
