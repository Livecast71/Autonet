...
+ (void) initialize
{
    ...
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[UIColor colorWithRed:0.921431 green:0.921453 blue:0.921441 alpha:0.1]];
        [circularProgressViewAppearance setProgressTintColor:[UIColor colorWithRed:0.921431 green:0.921453 blue:0.921441 alpha:1.000000]];
